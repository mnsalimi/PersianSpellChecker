...
def load_model(vocab):
    ...
    #for k,v in vocab["chartoken2idx"].items():
     #   print(k, v)
...
if __name__ == '__main__':
    ...
    #model_checkpoint_path = "/home/marefat/projects/PSC/Nevise/checkpoints/FARSI_SPELL_CHECKER___36.pt"
    #vocab_path = "/home/marefat/projects/PSC/Nevise/new_vocab.pkl"
    
    path_to_test = "/home/marefat/projects/PSC/Nevise/451_test.txt"
    ...
    for t in tqdm(test):
      ...
      with open("/home/marefat/projects/PSC/predictions_on_test_with_my_training.txt", "a+") as h:
        h.seek(0)
        h.writelines(f"===========================================================\n")
